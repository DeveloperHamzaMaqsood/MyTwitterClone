...
import People from './PeopleRetweet'
                ...
                <Row className="tweetsSec" style={{cursor:"pointer"}} >
                    ...
                    <Col sm={3}>
                        <Link  to = "/profile/retweet"
                            ...
                            <h6 className="h44 h442" style={{textDecoration:"underline", color : "#1DA1F2" ,  textDecorationThickness: "4px" ,  textUnderlineOffset: "10px" , textDecorationColor : "#1DA1F2"}} >Media</h6>
                        </Link>
                    </Col>
                    <Col sm={3}>
                        ...
                        style = {
                            ...
                            <h6 className="h44 h443"  >Likes</h6>
                        </Link>
                    </Col>
                </Row>
