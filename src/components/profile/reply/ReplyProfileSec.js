            ...
            <div className="profile">
                ...
                <Row className="tweetsSec" style={{cursor:"pointer"}} >
                    ...
                    <Col sm={3}>
                        ...
                        <h6 className="h44 h441"  style={{textDecoration:"underline", color : "#1DA1F2" ,  textDecorationThickness: "4px" ,  textUnderlineOffset: "10px" , textDecorationColor : "#1DA1F2"}}>Reply</h6>
                        </Link>
                    </Col>
                    <Col sm={3}>
